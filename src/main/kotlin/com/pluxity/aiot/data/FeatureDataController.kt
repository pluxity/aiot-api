...
class FeatureDataController(
    ...
    fun getPeriodData(
        ...
        ResponseEntity.ok(DataResponseBody(featureDataService.getTimeSeries(deviceId, interval, from, to)))
    ...
    fun getLatestData(
        ...
        ResponseEntity.ok(DataResponseBody(featureDataService.getLatestData(deviceId)))
}
