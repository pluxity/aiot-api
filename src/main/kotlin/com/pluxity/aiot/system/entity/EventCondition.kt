...
import com.pluxity.aiot.system.entity.DeviceEvent.DeviceLevel
...
class EventCondition(
    ...
    private var eventSetting: EventSetting? = null

    fun setEventSetting(eventSetting: EventSetting?) {
    ...
    private fun getDefaultOrderByDeviceLevel(): Int {
        ...
        return when (this.deviceEvent.deviceLevel) {
            DeviceLevel.NORMAL -> 1
            DeviceLevel.WARNING -> 2
            DeviceLevel.CAUTION -> 3
            DeviceLevel.DANGER -> 4
            DeviceLevel.DISCONNECTED -> -1
            else -> 0
        }
    }
