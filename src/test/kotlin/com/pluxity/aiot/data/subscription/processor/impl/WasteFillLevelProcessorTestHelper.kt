...
/**
 * WasteFillLevelProcessor 테스트를 위한 헬퍼 클래스
 */
class WasteFillLevelProcessorTestHelper(
    ...
    /**
     * WasteFillLevelProcessor 인스턴스 생성
     */
    fun createProcessor(): WasteFillLevelProcessor =
        WasteFillLevelProcessor(
            messageSenderMock,
            eventHistoryRepository,
            featureRepository,
            eventConditionRepository,
